...
void Core::doMultiMetrics(string HYP, string REF, Scores &hOQ) {
	...
	if (!REF.empty()) {
		...
		//pAlign->doMetric(HYP, REF, "", hOQ);

		delete pBLEU, pNIST, pMETEOR, pROUGE, pGTM, pNGRAM, pOverlap, pESA, pTER, pWER, pPER, pLeM, pSP, pCE, pNE, /*pCP, */pSR/*, pAlign*/;
	}
}
