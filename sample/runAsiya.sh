...
echo "../Asiya $CONFIG -time -v -eval single -g all sys -metric_set $METRICSET -data_path $FOLDER > $CONFIG.$METRICSET.report 2> $CONFIG.$METRICSET.err"
../Asiya $CONFIG -time -v -eval single -g all sys -metric_set $METRICSET -data_path $FOLDER > $CONFIG.$METRICSET.report 2> $CONFIG.$METRICSET.err
