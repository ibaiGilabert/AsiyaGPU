...
public:
	...
	static map<string, int> 	Hmetrics, 	wc, 	eval_schemes,	metaeval_criteria;
	...
	static string IQ_config, learn_scheme, ci, SORT, LANG, CASE, G, I ,O, SRCCASE, SRCLANG, src, tools, model;
